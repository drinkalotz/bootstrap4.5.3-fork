...
(function (global, factory) {
  ...
  class Modal {
    ...
    hide(event) {
      ...
      if (transition) {
        ...
        $__default['default'](this._element).one(Util__default['default'].TRANSITION_END, event => this._hideModal(event)).emulateTransitionEnd(transitionDuration);
      } else {
        this._hideModal();
      }
    }
    ...
    dispose() {
      [window, this._element, this._dialog].forEach(htmlElement => $__default['default'](htmlElement).off(EVENT_KEY));
      /**
    ...
    _triggerBackdropTransition() {
      if (this._config.backdrop === 'static') {
        ...
        const modalTransitionDuration = Util__default['default'].getTransitionDurationFromElement(this._dialog);
        $__default['default'](this._element).off(Util__default['default'].TRANSITION_END);
        $__default['default'](this._element).one(Util__default['default'].TRANSITION_END, () => {
    ...
    _showElement(relatedTarget) {
      ...
      if (transition) {
        const transitionDuration = Util__default['default'].getTransitionDurationFromElement(this._dialog);
    ...
    _showBackdrop(callback) {
      const animate = $__default['default'](this._element).hasClass(CLASS_NAME_FADE) ? CLASS_NAME_FADE : '';
      ...
      if (this._isShown && this._config.backdrop) {
        ...
        const backdropTransitionDuration = Util__default['default'].getTransitionDurationFromElement(this._backdrop);
        ...
        if ($__default['default'](this._element).hasClass(CLASS_NAME_FADE)) {
          const backdropTransitionDuration = Util__default['default'].getTransitionDurationFromElement(this._backdrop);
          $__default['default'](this._backdrop).one(Util__default['default'].TRANSITION_END, callbackRemove).emulateTransitionEnd(backdropTransitionDuration);
        } else {
          callbackRemove();
        }
      } else if (callback) {
  ...
  $__default['default'](document).on(EVENT_CLICK_DATA_API, SELECTOR_DATA_TOGGLE, function (event) {
    ...
    const config = $__default['default'](target).data(DATA_KEY) ? 'toggle' : { ...$__default['default'](target).data(),
      ...$__default['default'](this).data()
    };
